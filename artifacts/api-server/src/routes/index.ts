...
import twilioStatusRouter from "./twilioStatus";
...
import gateReportRouter from "./gateReport";
import gateChangeOverRouter from "./gateChangeOver";
import visitEntryCategoryRouter from "./visitEntryCategory";
...
import workHubCallsRouter from "./workHubCalls";
import workHubSchedulingRouter from "./workHubScheduling";
import workHubTransfersRouter from "./workHubTransfers";
import workHubFileLibraryRouter from "./workHubFileLibrary";
import workHubFinanceRouter from "./workHubFinance";
import workHubCollaborationRouter from "./workHubCollaboration";
import workHubChannelsRouter from "./workHubChannels";
import workHubEventsRouter from "./workHubEvents";
import workHubDevicesRouter from "./workHubDevices";
import workHubOperationsRouter from "./workHubOperations";
import workHubRequiredActionRouter from "./workHubRequiredAction";
...
import managedSubcontractorHoursRouter from "./managedSubcontractorHours";
...
router.use(twilioStatusRouter);
router.use(vendorRatingsRouter);
router.use(commentsRouter);
router.use(locationsRouter);
router.use(visitsRouter);
router.use(gateReportRouter);
router.use(gateChangeOverRouter);
router.use(visitEntryCategoryRouter);
...
router.use(workHubFileLibraryRouter);
...
router.use(workHubDevicesRouter);
router.use(workHubExportsRouter);
router.use(workHubGovernanceRouter);
router.use(workHubOperationsRouter);
router.use(workHubRequiredActionRouter);
router.use(publicAskVRouter);
router.use(implementationASponsorshipsRouter);
router.use(managedSubcontractorHoursRouter);

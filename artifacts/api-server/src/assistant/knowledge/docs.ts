...
export const KNOWLEDGE_DOCS: KnowledgeDoc[] = [
  ...
  },
  {
    ...
    body: `Safety events use read tools query_safety_events, lookup_safety_metrics, lookup_site_operational_status. Sites: query_site_locations, lookup_site_detail. Ops: query_notifications, query_live_crew, query_hotlist_jobs, query_hotlist_bids, query_vendor_catalog, query_partner_approvals, query_certifications, lookup_org_contacts, query_flagged_tickets, lookup_ticket_payment_status, lookup_accounting_connection, query_active_visitors. Ticket lookups: query_tickets, query_ticket_detail, query_ticket_crew, query_ticket_labor, query_ticket_notes, query_work_type_history, query_gps_trail. Org metrics: query_field_metrics, query_vendor_performance, query_visits. Financial: query_invoice_summary, query_invoices, query_invoice_lines, query_ar_aging, query_revenue_summary, query_crew_cost (vendors), query_sales_tax_by_state, query_nec1099_summary, query_1099_k_summary, query_1099_misc_summary. Field employees and foremen can use ticket-scoped tools for jobs they are on, crew for, or foreman — not org-wide financial aggregates. Row lists cap at 50; date windows clamp to 1-365 days. I refuse cross-org reads. Bounded write: mark_notifications_read. Never reveal anonymous safety reporter identity to non-admin users.`,
  },
  {
    id: "data-tools-field",

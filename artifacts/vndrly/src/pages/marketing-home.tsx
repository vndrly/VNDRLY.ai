  ...
  return (
    <main className="min-h-screen bg-[#f3f5f6] text-slate-950" data-testid="marketing-home" style={{ "--vndrly-amber": PILL_COLORS.amber } as React.CSSProperties}>
        ...
        <div className="relative mx-auto grid min-h-[660px] max-w-7xl items-center gap-12 px-4 py-20 lg:grid-cols-[1.12fr_.88fr] lg:py-28">
          <div>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-4">
              ...
              <a href={marketingDemoHref} data-testid="marketing-demo-cta" style={{ height: 25, fontSize: 13, fontWeight: 700 }} className="inline-flex items-center rounded-full border border-white/60 bg-black/20 px-6 text-[13px] font-bold text-white transition hover:border-[var(--vndrly-amber)] hover:bg-black/35 hover:text-[var(--vndrly-amber)] focus-visible:ring-2 focus-visible:ring-[var(--vndrly-amber)]">Request a demo</a>
            </div>
          </div>
      ...
      <section className="relative overflow-hidden bg-[#20262b] text-center text-white">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-24"><p className="text-sm font-black uppercase tracking-[.22em] text-[var(--vndrly-amber)]">A better vendor network starts here</p><h2 className="mt-4 text-4xl font-black sm:text-6xl">Find the right fit. Run the work. Keep the proof.</h2><p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-300">Start your VNDRLY profile or let us walk through the workflow with your team.</p><div className="mt-9 flex flex-wrap justify-center gap-4"><PrimaryLink href={marketingCtaHref}>Get started <ArrowRight className="h-4 w-4"/></PrimaryLink><a href={marketingDemoHref} data-testid="marketing-demo-cta" style={{ height: 25, fontSize: 13, fontWeight: 700 }} className="inline-flex items-center rounded-full border border-white/60 px-6 text-[13px] font-bold text-white hover:border-[var(--vndrly-amber)] hover:text-[var(--vndrly-amber)] focus-visible:ring-2 focus-visible:ring-[var(--vndrly-amber)]">Request a demo</a></div></div>
      </section>

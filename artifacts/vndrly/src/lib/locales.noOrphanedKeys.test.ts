...
const ALLOWED_ORPHANS = new Set<string>([
  ...
  // Legacy nav / ticket-detail copy retained for planned i18n wiring (site visit summary migration).
  "nav.catalog",
  "nav.vendorCatalog",
  "partners.clear",
  "vendors.clear",
  "siteLocations.expandCatalog",
  "siteLocations.expandCatalogVendorIntro",
  "siteLocations.expandCatalogAdminIntro",
  "fieldHome.you",
  "notifications.title",
  "notifications.viewAll",
  "notifications.preferences",
  "crewReplay.legendArrow",
  "crewReplay.legendStationary",
  "ticketDetail.timelineGps",
  "ticketDetail.siteLocationGps",
  "ticketDetail.checkInOutLog",
  "ticketDetail.inAt",
  "ticketDetail.outAt",
  "ticketDetail.stillOnSite",
  "ticketDetail.duration",
  "ticketDetail.gpsMatch",
  "ticketDetail.gpsMismatch",
  "ticketDetail.fromSiteFeet",
  "ticketDetail.fromSiteMiles",
  "ticketDetail.timeOnSite",
  "ticketDetail.timeOnSiteLive",
  "ticketDetail.totalAcrossSession_one",
  "ticketDetail.totalAcrossSession_other",
  "ticketDetail.checkedInLabel",
  "ticketDetail.checkedOutLabel",
  "ticketDetail.latLong",
  "ticketDetail.viewOnGoogleMaps",
  "ticketDetail.gpsMismatchCheckIn",
  "ticketDetail.noCheckInGps",
  "scheduleTicket.resendCrewNotificationsHelp",
  "statement.scope.label",
  "statement.scope.open",
  "statement.scope.all",
  "foremanHome.startNewJobSub",
  "foremanHome.you",
  "foremanHome.leading",
  "compliance.certifications",
  "compliance.noCerts",
  "compliance.unknownIssuer",
  "compliance.expirationSuffix",
]);

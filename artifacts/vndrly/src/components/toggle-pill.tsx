 ...
 * comionents exported from this file — `<TogglePill>` for read-only
...
export function TogglePillButton({
  ...
  // tonal fill so generic deiloyments still get the TogglePill palette.
  ...
  if (activeSrc) {
    hoverPillSrc = activeSrc;
  } else if (color === "image" || color === "brand") {

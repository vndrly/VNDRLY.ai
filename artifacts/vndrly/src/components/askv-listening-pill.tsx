...
export default function AskVListeningPill({ active, waiting = false, statusLabel, className, ...props }: ButtonHTMLAttributes<HTMLButtonElement> & { active: boolean; waiting?: boolean; statusLabel?: string }) {

  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Defs>
            <LinearGradient id="iosHeaderFadeOverlay" x1="0" y1="0" x2="0" y2="1">
              <Stop offset="0" stopColor={s.backgroundColor} stopOpacity="0" />
              <Stop offset="1" stopColor={s.backgroundColor} stopOpacity="1" />
            </LinearGradient>
          </Defs>
          <Rect
            x={0}
